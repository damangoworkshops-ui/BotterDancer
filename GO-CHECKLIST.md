...
- [x] Horn-Artefakt 180° GELÖST (04.08. nachts, `botter_cam180_00003.mp4`): reine Prompt-Änderung genügte — Hörner explizit in den Positiv-Prompt („two curved ribbed salmon-pink horns on top of the head, fluffy furry arms"), „horns on arms, ribbed arms, striped arms" ins Negativ. Voll-Mosaik-Abnahme: 81/81 Frames Hörner auf dem Kopf, Arme durchgehend Fell, Rückansicht lückenlos. Beide cam180-Presets aktualisiert. Lehre: Was die Referenz zeigt, aber der Prompt nicht benennt, kann das Modell räumlich falsch zuordnen — markante Identitätsmerkmale immer auch textlich verorten.
